...
{
    public class SkitSoundHelper : MonoBehaviour
    {
        //シート名
        ...
        public const string ClassBell = "SE_019_ClassBell";
        ...
        public const string VoiceAfterClassSelect = "Lian_24";
        public const string VoiceAfterClass = "Lian_25";
   
        public static string GetVoiceCueSheetName(string voiceName)
        {
            return voiceName.Contains("Lian") ? LianSheetName : PresidentOfTheStudentCouncil;
        }
    }
